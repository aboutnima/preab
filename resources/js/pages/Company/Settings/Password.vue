...
<template>
    <div class="max-w-lg">
        <div class="mb-6">
            ...
            <p class="mt-0.5 text-sm text-muted-foreground">Use a strong password of at least 8 characters.</p>
        </div>
